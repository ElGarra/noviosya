...
export async function getEffectiveWeddingId(session: Session): Promise<string> {
...
export function getEffectiveWeddingIdFromReq(req: NextRequest, session: Session): string {
  if (session.user.role === 'ADMIN') {
